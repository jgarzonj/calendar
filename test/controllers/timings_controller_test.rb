...
class TimingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timing" do
    assert_difference('Timing.count') do
      post timings_url, params: { timing: { day: @timing.day, month: @timing.month, name: @timing.name, semester: @timing.semester, year: @timing.year } }
    end
  ...
  test "should update timing" do
    patch timing_url(@timing), params: { timing: { day: @timing.day, month: @timing.month, name: @timing.name, semester: @timing.semester, year: @timing.year } }
